...
- [Rainfall Prediction Model](https://github.com/TheSonOfKrypton/Rainfall-Prediction-Model) – Sydney rainfall prediction using real-world data and ML (Random Forest, XGBoost, Logistic Regression).
